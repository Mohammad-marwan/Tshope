...
,validationSchema:schema
  ...
  return (
    ...
    <h2>{errors}</h2>
     <form onSubmit={formik.handleSubmit} className='w-50 m-auto d-flex flex-column'>
  ...
  <div className="form-floating">
    ...
    <div className="formBtn d-flex ">
    <button className='btn btn-dark my-3' type="submit">Login</button>
    <Link className='btn btn-dark' to={'/Sendcode'}>Sendcode</Link>
    <Link className='btn btn-dark' to={'/ForgotPassword'}>ForgotPassword</Link>
    </div>
  </div>
  </form>
    </div>
